...
int main(int argc, char* argv[]) {
    ...
    std::cout << "getInt(): " << viper::random::getRandomInt() << "\n";
    std::cout << "getInt(): " << viper::random::getRandomInt() << "\n";
    std::cout << "getInt(10): " << viper::random::getRandomInt(10) << "\n";
    std::cout << "getInt(10): " << viper::random::getRandomInt(10) << "\n";
    std::cout << "getInt(5, 15): " << viper::random::getRandomInt(5, 15) << "\n";
    std::cout << "getInt(5, 15): " << viper::random::getRandomInt(5, 15) << "\n";
    std::cout << "getInt(-10, 10): " << viper::random::getRandomInt(-10, 10) << "\n\n";
